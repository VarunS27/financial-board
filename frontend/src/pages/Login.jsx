...
import { Mail, Lock, ArrowRight, TrendingUp, DollarSign, PieChart, BarChart3 } from 'lucide-react';
          ...
          <div className="mt-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-end">
                <Link
                  to="/forgot-password"
                  className="text-sm font-medium text-white dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center px-12">
          <div className="max-w-lg">
            ...
            <p className="text-xl text-primary-100 mb-12 leading-relaxed">
              Track expenses, analyze investments, and make data-driven decisions with our powerful analytics dashboard.
            </p>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
                ...
                <h4 className="font-semibold text-lg mb-2">Track Expenses</h4>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
                ...
                <h4 className="font-semibold text-lg mb-2">Live Stock Data</h4>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 hover:bg-white/15 transition-all hover:scale-105">
                ...
                <h4 className="font-semibold text-lg mb-2">Smart Reports</h4>
